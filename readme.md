...
`efan` aims to hit the middle ground between programmatically rendering markup with [web::WebOutStream](https://fantom.org/doc/web/WebOutStream.html) and rendering logicless templates such as [Mustache](http://eggbox.fantomfactory.org/pods/mustache).
...
Or install `efan` with [fanr](https://fantom.org/doc/docFanr/Tool.html#install):
